...
export class Backend implements backendInterface {
    ...
    async getQuestionById(arg0: bigint): Promise<Question> {
    ...
    async getQuestions(arg0: string): Promise<Array<Question>> {
        if (this.processError) {
            try {
    ...
    async getTopScores(): Promise<Array<GameSession>> {
        if (this.processError) {
            try {
    ...
    async saveSession(arg0: string, arg1: bigint): Promise<bigint> {
        if (this.processError) {
            try {
